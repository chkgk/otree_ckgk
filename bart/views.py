...
class BlueTaskInstructions(Page):
	pass

class BlueMainTask(Page):
	form_model = models.Player
...
class GreenTaskInstructions(Page):
    pass

class GreenMainTask(Page):
    form_model = models.Player
...
page_sequence = [
   ...
   TrialInstructions,
   TrialPage,
   BlueTaskInstructions,
   BlueMainTask,
   GreenTaskInstructions,
   GreenMainTask,
   RiskQuestionnaire,
   Questionnaires,
   Results,
