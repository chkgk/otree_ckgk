function UI (treatment, color, intactSrc, poppedSrc) {
	...
	this.handleExplosion = function(event) {
		...
		this.hide(this.orangeButton);
		this.show(this.blueButton);
		this.updateText(this.blueButton, "next");
	...
	this.advanceBalloon = function() {
		...
		this.updateText(this.blueButton, "collect points");
	...
	this.setInstructions = function(status) {
		var instructions = {
			manual: {
				standard: "<p>Click on 'inflate' to pump air into the balloon.</p><p>Click on 'collect points' to secure points from the current balloon.</p>",
				boom: "<p>The balloon has popped.</p><p>Click on the blue button to move on.</p>",
			},
			automatic: {
				standard: "<p>Move the cursor over the red field to start inflating the balloon.</p>",
				waiting: "<p>Points collected!</p><p>Click on the blue button to move on.</p>",
				running: "<p>The balloon is being inflated.</p><p>Move the cursor off the red field to stop inflating.</p>",
				boom: "<p>The balloon has popped.</p><p>Click on the blue button to move on.</p>"
			},
		};
